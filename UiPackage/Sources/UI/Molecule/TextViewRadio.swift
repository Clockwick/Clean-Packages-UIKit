...
public class TextViewRadio: UIView {
...
extension TextViewRadio: UITextViewDelegate {
...
extension TextViewRadio: UIGestureRecognizerDelegate {
...
public extension Reactive where Base: TextViewRadio {
  @MainActor
  var text: ControlProperty<String> {
    .init(values: base.textRelay.asObservable(),
          valueSink: Binder(base) { textViewRadio, text in
      textViewRadio.text = text
    })
  }
